...
public abstract class _ManagerDisp extends Ice.ObjectImpl implements Manager
{
    ...
    {
        return register(PESEL, password, null);
    }
    ...
    ___register(Manager __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        try
        {
            boolean __ret = __obj.register(PESEL, password, __current);
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type Bank::Manager was not generated with stream support";
        throw ex;
    }
